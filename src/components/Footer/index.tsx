      ...
      <footer>
        <div className="links-con">
          <ul>
            ...
            <li>
              <a id="footer-order-now" href="/buy-now">
                Buy Now
              </a>
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <a href="/consumer-health-data-privacy-policy">
          ...
          <ul>
            ...
            <li>
              <a href="tel:+91-9742931931" target="_blank">
                +91-9742931931
              </a>
            </li>
            <li>
              <a href="mailto:help@inito.com" target="_blank">
                help@inito.com
              </a>
            </li>
            <li>
        ...
        <div className="bottom-bar">
          <div className="bottom-bar-inner-con">
            ...
            <p className="font-med">
              Copyright 2024. Samplytics Technologies Private Limited. All
              Rights Reserved.
            </p>
          </div>
        </div>
